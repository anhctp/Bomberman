...
## Contributors
- [Cao Thị Phương Anh (21020272) - K66J](https://github.com/ctpanh)
- [Nguyễn Thị Thanh Thuỷ (21020411) - K66J](https://github.com/NguyenThuy25)
...
Các loại Enemy trong Bomberman:
- ![](res/sprites/balloom_left1.png) *Balloom* là Enemy đơn giản nhất, di chuyển ngẫu nhiên với vận tốc cố định
- ![](res/sprites/doll_left1.png) *Ghost* di chuyển ngẫu nhiên với vận tốc cố định (có thể đi qua mọi vật trừ Wall)
...
- Nâng cấp thuật toán tìm đường cho Enemy (A*)
- Cài thêm Enemy (Ghost, Oneal)
- Xử lý hiệu ứng âm thanh
- Thiết kế menu với các tính năng: pause, play, level up, timeCounter, HP.
